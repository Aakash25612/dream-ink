...
const Pricing = () => {
  ...
  const monthlyPlans = [{
    ...
    features: ["60 images / month", "2 images / day"],
    ...
    features: ["120 images / month", "4 images / day"],
    ...
    features: ["300 images / month", "10 images / day"],
  ...
  const weeklyPlans = [{
    ...
    features: ["21 images / week", "3 images / day"],
    ...
    features: ["49 images / week", "7 images / day"],
    ...
    features: ["119 images / week", "17 images / day"],
