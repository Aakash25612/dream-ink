    ...
    <div className="min-h-screen bg-[radial-gradient(ellipse_at_top,hsl(220_60%_15%),hsl(220_40%_5%))] flex flex-col items-center justify-center p-4">
      <div className="text-center space-y-8">
        ...
        <h1 
          ...
          style={{
            filter: "drop-shadow(0 0 30px hsl(200_100%_70% / 0.5)) drop-shadow(0 0 60px hsl(217_91%_60% / 0.3))"
          }}
        >
          CRETERA
        </h1>
        ...
        <p 
          className={`text-3xl md:text-4xl text-foreground font-light transition-opacity duration-700 ${
