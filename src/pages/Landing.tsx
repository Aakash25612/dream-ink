...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(ellipse_at_top,hsl(220_60%_15%),hsl(220_40%_5%))] flex flex-col items-center justify-center p-4 relative">
      {/* Main Content */}
      <div className="text-center space-y-6 flex-1 flex flex-col justify-center px-4">
        {/* CRETERA with neon blue glow */}
        <h1 
          className="text-5xl sm:text-7xl md:text-9xl font-bold bg-gradient-to-r from-[hsl(200_100%_70%)] to-[hsl(217_91%_60%)] bg-clip-text text-transparent tracking-wide"
          style={{
        ...
        <p 
          className={`text-xl sm:text-2xl md:text-3xl text-foreground/90 font-light transition-opacity duration-700 ${
